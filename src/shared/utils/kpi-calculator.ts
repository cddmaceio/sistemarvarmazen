 ...
 */
export function calcularDiasUteisMes(year: number, month: number): number {
  const diasUteis = [];
 ...
 */
export function calcularValorKpiDinamico(
  year: number, 
  month: number, 
  orcamentoMensal: number = 150.00,
  maxKpisPorDia: number = 2
): number {
 ...
 */
export function calcularInfoKpiMes(
  year: number, 
  month: number, 
  orcamentoMensal: number = 150.00,
  maxKpisPorDia: number = 2
 ...
 * @returns Valor por KPI em reais
 */
export function calcularValorKpiMesAtual(
  orcamentoMensal: number = 150.00,
  maxKpisPorDia: number = 2
): number {
