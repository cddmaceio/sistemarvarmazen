...
function Dashboard() {
    const { user, isAdmin, isCollaborator, userFunction } = (0, useAuth_1.useAuth)();
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const dadosUsuario = isCollaborator ? historico.filter((item) => item.colaborador_cpf === user?.cpf &&
                new Date(item.data_lancamento).getMonth() === mesAtual.getMonth() &&
                new Date(item.data_lancamento).getFullYear() === mesAtual.getFullYear()) : historico.filter((item) => new Date(item.data_lancamento).getMonth() === mesAtual.getMonth() &&
    ...
    const getActivityIcon = (nome) => {
        ...
        if (nome.includes('Empilhadeira'))
            return '🏗️';
        if (nome.includes('KPIs Atingidos'))
            return '📊';
        return '⚡';
    };
    ...
    const exportarRelatorio = () => {
        ...
        const dados = `Relatório de Performance - ${mesAtual.toLocaleDateString('pt-BR', { month: 'long', year: 'numeric' })}\n\n` +
            ...
            `Atividades:\n` +
            dashboardData.atividades.map(ativ => `${ativ.nome}: R$ ${ativ.totalGanho.toFixed(2)} (${ativ.dias} dias)`).join('\n');
    ...
    if (!dashboardData) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center">
          <Card_1.Card className="max-w-md">
            <Card_1.CardHeader>
              <Card_1.CardTitle className="text-red-700">Dados Indisponíveis</Card_1.CardTitle>
              <Card_1.CardDescription>
                Não foi possível carregar os dados de performance.
              </Card_1.CardDescription>
            </Card_1.CardHeader>
            <Card_1.CardContent>
              <Button_1.Button onClick={fetchDashboardData} className="w-full">
                Tentar Novamente
              </Button_1.Button>
            </Card_1.CardContent>
          </Card_1.Card>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center">
                  <lucide_react_1.TrendingUp className="h-5 w-5 text-white"/>
                </div>
                <div>
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card_1.Card className="bg-gradient-to-r from-yellow-50 to-orange-50 border-yellow-200">
                <Card_1.CardHeader>
                  <Card_1.CardTitle className="text-lg text-yellow-800">🥇 TOP ATIVIDADE DO MÊS</Card_1.CardTitle>
                </Card_1.CardHeader>
                <Card_1.CardContent>
                  {dashboardData.atividades.length > 0 && (<div className="space-y-2">
              ...
              <Card_1.Card className="bg-gradient-to-r from-red-50 to-pink-50 border-red-200">
                <Card_1.CardHeader>
                  <Card_1.CardTitle className="text-lg text-red-800">🔥 MELHOR DIA</Card_1.CardTitle>
                </Card_1.CardHeader>
                <Card_1.CardContent>
              ...
              <Card_1.Card className="bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-200">
                <Card_1.CardHeader>
                  <Card_1.CardTitle className="text-lg text-purple-800">⭐ MAIOR PRODUTIVIDADE</Card_1.CardTitle>
                </Card_1.CardHeader>
                <Card_1.CardContent>
                  <div className="space-y-2">
            ...
            <Card_1.Card>
              <Card_1.CardHeader>
                <Card_1.CardTitle className="flex items-center space-x-2">
                  <lucide_react_1.BarChart3 className="h-6 w-6"/>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div className="bg-gradient-to-r from-green-400 to-green-600 h-3 rounded-full transition-all duration-300" style={{ width: `${Math.min(dashboardData.kpis.metaMensal, 100)}%` }}></div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div className="bg-gradient-to-r from-blue-400 to-blue-600 h-3 rounded-full transition-all duration-300" style={{ width: `${dashboardData.kpis.produtividade}%` }}></div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div className="bg-gradient-to-r from-purple-400 to-purple-600 h-3 rounded-full transition-all duration-300" style={{ width: `${dashboardData.kpis.eficiencia}%` }}></div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div className="bg-gradient-to-r from-yellow-400 to-yellow-600 h-3 rounded-full transition-all duration-300" style={{ width: `${dashboardData.kpis.pontualidade}%` }}></div>
                      </div>
            ...
            <Card_1.Card className="bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200">
              <Card_1.CardHeader>
                <Card_1.CardTitle className="flex items-center space-x-2 text-indigo-800">
                  <lucide_react_1.Star className="h-6 w-6"/>
