        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-7xl mx-auto">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <Input placeholder="Nome do colaborador" value={filtros.colaborador} onChange={(e) => handleFiltroChange('colaborador', e.target.value)}/>
                  </div>
                  ...
                  <div>
                    ...
                    <Input placeholder="Nome do admin" value={filtros.admin} onChange={(e) => handleFiltroChange('admin', e.target.value)}/>
                  </div>
                  ...
                  <div>
                    ...
                    <Select value={filtros.editado} onChange={(e) => handleFiltroChange('editado', e.target.value)}>
            ...
            {loading ? (<div className="text-center py-8">
                ...
                return (<Card key={item.id} className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                      <CardContent className="p-6">
