...
export default function Dashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const dadosUsuario = isCollaborator ? historico.filter((item) => {
                ...
                <div className="space-y-3">
                  {dashboardData.historicoCompleto.length > 0 ? (<>
                      ...
                      <div className="hidden md:block">
                        ...
                        {dashboardData.historicoCompleto.slice(0, 10).map((item, index) => (<div key={index} className="grid grid-cols-4 gap-4 text-sm py-2 border-b border-gray-100 hover:bg-blue-50 transition-colors">
                        ...
                        {dashboardData.historicoCompleto.length > 10 && (<div className="text-center py-3 text-sm text-gray-500">
                      ...
                      <div className="md:hidden space-y-3">
                        {dashboardData.historicoCompleto.slice(0, 5).map((item, index) => (<div key={index} className="bg-white p-3 rounded-lg border border-blue-200 shadow-sm">
                        ...
                        {dashboardData.historicoCompleto.length > 5 && (<div className="text-center py-2 text-sm text-gray-500">
