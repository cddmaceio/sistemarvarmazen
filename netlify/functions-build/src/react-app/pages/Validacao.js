...
export default function Validacao() {
    ...
    const fetchLancamentosPendentes = async () => {
        try {
            const response = await fetch(`${API_BASE}/lancamentos/pendentes`);
            if (!response.ok) {
    ...
    return (<AuthGuard>
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            {loading ? (<div className="text-center py-8">
                ...
                return (<Card key={lancamento.id} className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
                      ...
                      <CardContent className="pt-0">
                        ...
                        <Button variant="outline" size="sm" onClick={() => setShowDetails(isExpanded ? null : String(lancamento.id))} className="mb-4 w-full">
                        ...
                        <div className="mb-4">
                          ...
                          <Input value={selectedLancamento?.id === lancamento.id ? observacoes : ''} onChange={(e) => {
                        ...
                        handleValidacao(lancamento.id, 'reprovar');
                          ...
                          <Button variant="outline" className="px-6" disabled={processando === String(lancamento.id)} onClick={() => handleEditLancamento(lancamento)}>
        ...
        {/* Edit Modal */}
        <EditLancamentoModal open={editModalOpen} onClose={() => {
            setEditModalOpen(false);
            setEditingLancamento(null);
