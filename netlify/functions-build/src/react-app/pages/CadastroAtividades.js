...
import { FUNCOES_UI_FORMAT, convertToDbFormat } from '@/shared/utils/encoding';
              ...
              <CardContent>
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  <div className="flex-1">
                    <Input placeholder="🔍 Buscar por nome ou nível da atividade..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
                  </div>
              ...
              <CardContent>
                {loading ? (<div className="flex items-center justify-center py-8">
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {filteredActivities.map((activity) => (<TableRow key={activity.id}>
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-2">
                                <Button variant="outline" size="sm" onClick={() => openEditDialog(activity)} className="text-blue-600 hover:text-blue-800">
                                  <Edit className="h-3 w-3"/>
                                </Button>
                                <Button variant="destructive" size="sm" onClick={() => handleDelete(activity)} className="text-red-600 hover:text-red-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input value={formData.nome_atividade} onChange={(e) => setFormData(prev => ({ ...prev, nome_atividade: e.target.value }))} placeholder="ex: Prod Repack, Prod Retrabalho" required/>
                ...
                <div className="space-y-2">
                  ...
                  <Input value={formData.nivel_atividade} onChange={(e) => setFormData(prev => ({ ...prev, nivel_atividade: e.target.value }))} placeholder="ex: Nível 1 (0 cxs/h)" required/>
                  <p className="text-xs text-gray-500">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" step="0.01" min="0" value={formData.valor_atividade} onChange={(e) => setFormData(prev => ({ ...prev, valor_atividade: e.target.value }))} placeholder="0.00" required/>
                  <p className="text-xs text-gray-500">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" step="0.1" min="0" value={formData.produtividade_minima} onChange={(e) => setFormData(prev => ({ ...prev, produtividade_minima: e.target.value }))} placeholder="0.0"/>
                  <p className="text-xs text-gray-500">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.unidade_medida} onChange={(e) => setFormData(prev => ({ ...prev, unidade_medida: e.target.value }))}>
              ...
              <div className="flex justify-end space-x-2 pt-4">
                <Button type="button" variant="outline" onClick={() => setShowDialog(false)} className="flex items-center space-x-2">
                  <X className="h-4 w-4"/>
                  <span>Cancelar</span>
                </Button>
                <Button type="button" variant="outline" onClick={resetForm} className="flex items-center space-x-2">
