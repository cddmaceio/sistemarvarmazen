...
import ResetButton from '@/react-app/components/ResetButton';
function LoginForm() {
    const { login } = useAuth();
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input value={cpf} onChange={handleCPFChange} placeholder="000.000.000-00" maxLength={14} required/>
            </div>
            ...
            <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900">
...
export function AuthGuard({ children, requireAdmin = false, fallback }) {
