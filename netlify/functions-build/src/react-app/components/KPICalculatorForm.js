...
export default function KPICalculatorForm({ onCalculate, disabled }) {
    ...
    return (<Card className="border-0 shadow-xl bg-gradient-to-br from-white via-blue-50 to-purple-50">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <Input type="date" value={dataLancamento} onChange={(e) => setDataLancamento(e.target.value)} className="w-auto text-right" disabled={disabled}/>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
        ...
        {limitInfo && (<div className={`p-4 rounded-lg border-l-4 ${canLaunchKPIs
            ...
            <div className="flex items-center space-x-2">
              {canLaunchKPIs ? (<Target className="h-5 w-5"/>) : (<AlertTriangle className="h-5 w-5"/>)}
              <div>
        ...
        {!canLaunchKPIs && (<Alert variant="destructive">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {showFunctionSelector && (<div className="space-y-2">
              ...
              <Select value={formData.funcao} onChange={(e) => setFormData(prev => ({ ...prev, funcao: e.target.value }))} disabled={disabled}>
          ...
          {!isAdmin ? (<div className="p-3 bg-green-50 rounded-lg border border-green-200">
          ...
          {calcError && (<Alert variant="destructive">
