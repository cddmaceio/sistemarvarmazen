    ...
    return (<>
      <div className="relative">
        ...
        {showMenu && createPortal(<>
            ...
            {isCollaborator && (<>
                <Link to="/" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <Calendar className="mr-3 h-4 w-4"/>
                  Calculadora
                </Link>
                <Link to="/dashboard" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
            ...
            {/* Admin Menu Items */}
            {isAdmin && (<>
                <Link to="/admin/atividades" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <Activity className="mr-3 h-4 w-4"/>
                  Cadastro de Atividades
                </Link>
                <Link to="/admin/kpis" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <Target className="mr-3 h-4 w-4"/>
                  Cadastro de KPIs
                </Link>
                <Link to="/admin/cadastro-usuarios" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <UserPlus className="mr-3 h-4 w-4"/>
                  Cadastro de Usuários
                </Link>
                <Link to="/admin/validacao" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <CheckCircle className="mr-3 h-4 w-4"/>
                  Validação de Lançamentos
                </Link>
                <Link to="/admin/historico" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
                  <History className="mr-3 h-4 w-4"/>
                  Histórico de Aprovações
                </Link>
                <Link to="/admin/exportacao" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" onClick={() => setShowMenu(false)}>
